...
export class SearchDebuggerView {
        ...
        switch (message.command) {
            ...
            case 'stateSelected':
                try {
                    ...
                    this.sendRequestToPlanimationApi(message.stateInfo, message.domain, message.problem, message.animation);
                }
                catch (ex) {
    ...
    sendRequestToPlanimationApi(subGoal: string, domain: string, problem: string, ap: string): void{
